...
<body>
    <div class="sidebar">
        ...
        <nav class="nav flex-column mt-3">
            ...
            <a href="{{ route('reports.cash-flow') }}" class="nav-link">
                <i class="fas fa-money-bill-wave"></i> Cash Flow
            </a>
            <a href="{{ route('reports.general-ledger') }}" class="nav-link">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ route('settings.profile') }}" class="dropdown-item">Profile</a></li>
