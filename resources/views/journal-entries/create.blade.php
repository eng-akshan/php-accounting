...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('journal-entries.store') }}" id="entryForm">
            @csrf
            <div class="row mb-4">
                <div class="col-md-4">
            ...
            <table class="table" id="linesTable">
                ...
                <tbody id="linesBody">
                    <tr>
                        ...
                        <td><input type="number" name="lines[0][debit]" class="form-control text-end debit" step="0.01" min="0" value="0"></td>
                        <td><input type="number" name="lines[0][credit]" class="form-control text-end credit" step="0.01" min="0" value="0"></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td><input type="number" name="lines[1][debit]" class="form-control text-end debit" step="0.01" min="0" value="0"></td>
                        <td><input type="number" name="lines[1][credit]" class="form-control text-end credit" step="0.01" min="0" value="0"></td>
                        <td></td>
                    </tr>
                </tbody>
                <tfoot>
